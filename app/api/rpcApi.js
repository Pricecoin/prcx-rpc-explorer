...
const debugLog = debug("prcxexp:rpc");
...
function getIndexInfo() {
	if (semver.gte(global.prcxNodeSemver, minRpcVersions.getindexinfo)) {
...
function getDeploymentInfo() {
	if (semver.gte(global.prcxNodeSemver, minRpcVersions.getdeploymentinfo)) {
...
function getBlockTemplate() {
	return getRpcDataWithParams({method:"getblocktemplate", parameters:[{"rules": ["segwit", "mweb"]}]});
}
...
function getBlockStats(hash) {
	if (semver.gte(global.prcxNodeSemver, minRpcVersions.getblockstats)) {
